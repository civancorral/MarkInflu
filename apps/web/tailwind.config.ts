  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        'bento-hover': '0 14px 28px rgba(0, 0, 0, 0.25), 0 10px 10px rgba(0, 0, 0, 0.22)',
      },
      backgroundImage: {
        'gradient-radial': 'radial-gradient(var(--tw-gradient-stops))',
        'gradient-conic': 'conic-gradient(from 180deg at 50% 50%, var(--tw-gradient-stops))',
        'mesh-gradient': `
          radial-gradient(at 40% 20%, hsla(266, 100%, 60%, 0.2) 0px, transparent 50%),
          radial-gradient(at 80% 0%, hsla(225, 100%, 60%, 0.15) 0px, transparent 50%),
          radial-gradient(at 0% 50%, hsla(266, 100%, 50%, 0.1) 0px, transparent 50%),
          radial-gradient(at 80% 50%, hsla(340, 100%, 60%, 0.1) 0px, transparent 50%),
          radial-gradient(at 0% 100%, hsla(266, 100%, 60%, 0.15) 0px, transparent 50%)
        `,
